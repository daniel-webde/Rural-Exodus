...
const PersonalDetails = ({ donationAmount, paymentPlan }) => {
  ...
  return (
    <div className="flex flex-col px-4 lg:px-6 py-4 border-2 my-4 rounded-lg hover:shadow-md bg-white">
      ...
      <select
        className="rounded-lg text-lg shadow-md ps-4 py-1 text-slate-900 font-montreal"
        id="paymentMethod"
        value={identity}
      ...
      {identity === 0 && (
        <Fragment>
          ...
          <input type="text" name="firstname" id="firstname" className="rounded-lg text-lg shadow-md focus:outline-none ps-4 py-1 text-slate-900 font-montreal" />
          <label className="text-sm font-montreal text-gray-500">Last Name</label>
          <input type="text" name="lastname" id="lastname" className="rounded-lg text-lg shadow-md focus:outline-none ps-4 py-1 text-slate-900 font-montreal" />
        </Fragment>
      )}
      ...
      {identity === 1 && (
        <Fragment>
          ...
          <input type="text" name="companyName" id="companyName" className="rounded-lg text-lg shadow-md focus:outline-none ps-4 py-1 text-slate-900 font-montreal" />
        </Fragment>
      )}
      ...
      {identity === 2 && (
        <Fragment>
          ...
          <input type="text" name="trustName" id="trustName" className="rounded-lg text-lg shadow-md focus:outline-none ps-4 py-1 text-slate-900 font-montreal" />
        </Fragment>
      )}
      ...
      <input 
        ...
        name="email" 
        id="email" 
        className="rounded-lg text-lg shadow-md focus:outline-none ps-4 py-1 text-slate-900 font-montreal" 
      />
      ...
      <button type="submit" className="bg-gray-900 text-white font-montreal font-bold text-sm mx-auto px-5 py-2 rounded-lg">
